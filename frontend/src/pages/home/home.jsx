...
import { Box, Card, CardContent, CardMedia, Typography, IconButton, Button, Grid, CircularProgress } from '@mui/material';
import { ArrowBack, ArrowForward } from '@mui/icons-material';
import axios from 'axios';

const HomePage = () => {
    // Анхны номын мэдээлэл
    const [book] = useState([
        {   
        ...
        <Box padding={2} display="flex" justifyContent="center" alignItems="center" flexDirection="column">
            <Box sx={{ flexGrow: 1 }}>
                <Grid container spacing={3}>
                    ...
                    <Grid item xs={6} sx={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", textAlign: "center" }}>
                        <Typography variant="h4" sx={{ textDecoration: 'underline', marginBottom: '10px' }}>
                            {book[0].title}
                        </Typography>
                    ...
                    {loading ? (
                        ...
                        books.map((book) => (
                            <Card key={book.id} sx={{
                                ...
                                {book.image_url && (
                                    <CardMedia component="img" height="200" image={book.image_url} alt={book.title} />
                                )}
                                <CardContent>
